...
alias au='sudo apt-fast update'
alias uu='sudo apt-fast update && apt-fast full-upgrade'
alias rr='rm -rf '
alias ac='sudo apt autoremove && sudo apt clean'
alias cc='google-chrome &>/dev/null'
alias xo='xdg-open '
